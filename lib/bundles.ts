    ...
    if (rows.length > 0) {
      return rows.map((b) => {
        ...
        return {
          ...
          olPrice: b.olPrice !== null && b.olPrice !== undefined ? Number(b.olPrice) : fallback?.olPrice,
          olLkrPrice: b.olLkrPrice !== null && b.olLkrPrice !== undefined ? Number(b.olLkrPrice) : fallback?.olLkrPrice || 0,
          popular: b.popular,
          badge: b.badge,
  ...
  await prisma.$transaction(async (tx) => {
    ...
    await tx.tokenBundle.createMany({
      data: bundles.map((b) => ({
        ...
        price: b.price,
        lkrPrice: b.lkrPrice,
        olPrice: b.olPrice !== undefined ? b.olPrice : null,
        olLkrPrice: b.olLkrPrice !== undefined ? b.olLkrPrice : 0,
        popular: b.popular,
        badge: b.badge,
        description: b.description,
