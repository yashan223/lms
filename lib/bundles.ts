    ...
    if (rows.length > 0) {
      return rows.map((b) => {
        ...
        return {
          ...
          lkrPrice: Number(b.lkrPrice) > 0 ? Number(b.lkrPrice) : fallback?.lkrPrice || 0,
          olPrice: b.olPrice !== null && b.olPrice !== undefined && Number(b.olPrice) > 0 ? Number(b.olPrice) : fallback?.olPrice,
          olLkrPrice: b.olLkrPrice !== null && b.olLkrPrice !== undefined && Number(b.olLkrPrice) > 0 ? Number(b.olLkrPrice) : fallback?.olLkrPrice || 0,
          popular: b.popular,
          badge: b.badge,
          ...
          features:
            b.features && Array.isArray(b.features) && b.features.length > 0
              ...
              : fallback?.features || [
                  ...
                  "Access to live syllabus individual classes",
  ...
  await prisma.$transaction(async (tx) => {
    ...
    await tx.tokenBundle.createMany({
      data: bundles.map((b) => ({
        ...
        lkrPrice: Number(b.lkrPrice) || 0,
        olPrice: b.olPrice !== undefined && b.olPrice !== null && Number(b.olPrice) > 0 ? Number(b.olPrice) : null,
        olLkrPrice: b.olLkrPrice !== undefined && b.olLkrPrice !== null && Number(b.olLkrPrice) > 0 ? Number(b.olLkrPrice) : 0,
        popular: b.popular,
        badge: b.badge,
        description: b.description,
