...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "Yes. Every course includes comprehensive downloadable study materials including official lecture handbooks, unit formula sheets, worked past paper solutions, and practical laboratory guides without any assignment grading burdens.",
  },
  {
    id: "faq-3",
    category: "Tutors",
